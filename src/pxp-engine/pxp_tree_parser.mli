...
(** There are two types of XML texts one can parse:
    ...
    The following functions allow it to parse a file like "file.xml"
    as if it was included into a bigger document. This is what is meant
    by "parsing an external entity". 
